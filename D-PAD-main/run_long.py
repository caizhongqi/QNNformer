...
# -------  dataset settings --------------
parser.add_argument('--data', type=str, required=False, default='traffic', choices=[
                    'ETTh1', 'ETTh2', 'ETTm1', 'ETTm2', 'ECL', 'traffic', 'weather', 'hs300','electricity'], help='name of dataset')
parser.add_argument('--root_path', type=str,
                    default='./data', help='root path of the data file')
parser.add_argument('--data_path', type=str,
                    default='traffic.csv', help='location of the data file')
